...
// ---------------------------------------------------------------------------
// Prompt 173: the 170a supplement §16 helix parity block for the text-native
// entry path was removed when the 170m surface retired. The seeded
// helix_earning_event_types rows for the related events stay in the
// database as dormant rows per append-only discipline.
// ---------------------------------------------------------------------------
