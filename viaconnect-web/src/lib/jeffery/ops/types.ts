...
>[] = [
  ...
  {
    job_key: "jeffery.kb_review",
    agent_id: "jeffery",
    label: "Jeffery KB bridge and fail-closed review (221A)",
    interval_minutes: 15,
    priority: 12,
    budget_class: "C",
    mechanism: "hybrid",
    ...
    timeout_minutes: 20,
    coalesce_window_sec: 60,
    config: { bridge_limit: 12, review_limit: 20 },
  },
  {
    job_key: "hounddog.competitive",
    agent_id: "hounddog",
    ...
    timeout_minutes: 40,
    coalesce_window_sec: 300,
    config: { phase: 2, collection: "competitive_supplements" },
  },
  {
    job_key: "elysium.genetic_tests",
    agent_id: "elysium",
    ...
    timeout_minutes: 40,
    coalesce_window_sec: 300,
    config: { phase: 2, collection: "genetic_tests" },
  },
  {
