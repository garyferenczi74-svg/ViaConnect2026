  ...
  const whoBody = whoFromSplit
    ...
    : normalizeProductCopy(
        `## Who Benefits & What Makes This Different?\n\n` +
          ...
          `**What makes this different:** Via Cura formulates with bioactive nutrient forms and delivery technologies designed for higher bioavailability. The locked phrase is **Maximum Bioavailability**. Built For Your Biology.\n\n` +
