...
- Standard Multivitamin → CATALYST+ Energy Multivitamin: "Comprehensive with Maximum Bioavailability"
  ...
  "recommendations": [
    {
      ...
      "bioavailability_note": "Maximum Bioavailability compared with their current Brand X product (if applicable)",
      "contraindications": [],
      "interaction_check": "safe|caution|consult-provider",
