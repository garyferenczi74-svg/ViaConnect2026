...
export const HORMONE_IQ_DEEP_DRAFTS: Record<string, SnpDeepReport> = {
  ...
  cyp1b1: {
    ...
    protocolTieIn:
      "Via Cura pairs a faster four-hydroxy routing tendency with the downstream methyl, magnesium, and antioxidant support that finishes clearance of the reactive metabolites, alongside cruciferous derived nutrients, delivered through the micellar and liposomal dual delivery system for 10x to 28x absorption. Track your estrogen metabolite balance as part of your Bio Optimization picture.",
    laySummary: [
  ...
  cyp19a1: {
    ...
    protocolTieIn:
      "Via Cura supports a healthy estrogen to androgen balance through body composition, activity, and clearance supportive nutrition, delivered through the micellar and liposomal dual delivery system for 10x to 28x absorption. Track your estrogen and androgen metabolites together as part of your Bio Optimization picture.",
    laySummary: [
  ...
  srd5a2: {
    ...
    protocolTieIn:
      "Via Cura supports balanced androgen status through whole food nutrition, body composition, and activity, reading this conversion step in the context of your full androgen picture, with supporting nutrients delivered through the micellar and liposomal dual delivery system for 10x to 28x absorption. Track your androgen metabolites as part of your Bio Optimization picture.",
    laySummary: [
