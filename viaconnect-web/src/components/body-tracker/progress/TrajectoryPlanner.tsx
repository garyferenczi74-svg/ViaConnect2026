    ...
    <section className="rounded-2xl border border-white/[0.08] bg-[#1E3054]/60 p-5 backdrop-blur-sm">
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Flag className="h-4 w-4 text-[#2DA5A0]" strokeWidth={1.5} />
      ...
      <div className="mt-4">
        ...
        <div className="inline-flex rounded-full border border-white/15 bg-white/[0.04] p-1">
          <button
            ...
            className={`inline-flex items-center gap-1.5 rounded-full px-3.5 py-1.5 text-xs font-medium transition ${driver === 'rate' ? 'bg-[#2DA5A0]/20 text-white' : 'text-white/55'}`}
          >
          ...
          <button
            ...
            className={`inline-flex items-center gap-1.5 rounded-full px-3.5 py-1.5 text-xs font-medium transition ${driver === 'date' ? 'bg-[#2DA5A0]/20 text-white' : 'text-white/55'}`}
          >
      ...
      <button
        ...
        className="mt-4 w-full rounded-full border border-[#2DA5A0]/50 bg-[#2DA5A0]/20 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#2DA5A0]/30 disabled:opacity-50 sm:w-auto sm:px-6"
      >
