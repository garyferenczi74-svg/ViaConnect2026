...
export const REGION_HIT_RECTS_BY_SEX: Record<Sex, Record<BodyRegionId, RegionHitRect>> = {
  male: {
    ...
    hip:       { xPct: 49.6, yPct: 50.0, widthPct: 26, heightPct: 12 },
    waist:     { xPct: 49.6, yPct: 38.9, widthPct: 20, heightPct: 10 },
    l_quad:    { xPct: 41.2, yPct: 60.0, widthPct: 16, heightPct: 16 },
    r_quad:    { xPct: 58.9, yPct: 60.1, widthPct: 16, heightPct: 16 },
  ...
  female: {
    ...
    hip:       { xPct: 49.9, yPct: 49.5, widthPct: 30, heightPct: 12 },
    waist:     { xPct: 49.9, yPct: 38.4, widthPct: 22, heightPct: 10 },
    l_quad:    { xPct: 41.5, yPct: 58.6, widthPct: 16, heightPct: 16 },
    r_quad:    { xPct: 59.3, yPct: 58.1, widthPct: 16, heightPct: 16 },
