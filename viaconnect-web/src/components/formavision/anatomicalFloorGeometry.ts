// Bundled FormaVision anatomical 2D floor (Brief 59 honesty amend).
//
// Designed muscle-line figure — A-pose, ankle crop, plasma-teal chrome lock.
// Loading / hard-failure only. Not a Ready result. Not Picasso. Not the #177
// circle-head stick. Not a morph. Not SVG→mesh.
