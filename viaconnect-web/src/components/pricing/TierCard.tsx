...
export function TierCard({
  ...
  return (
    ...
    >
      {isRecommended && (
        <span className="absolute -top-3 left-1/2 -translate-x-1/2 inline-flex items-center gap-1 rounded-full bg-[#2DA5A0] text-[#0B1520] px-3 py-1 text-[11px] font-semibold">
