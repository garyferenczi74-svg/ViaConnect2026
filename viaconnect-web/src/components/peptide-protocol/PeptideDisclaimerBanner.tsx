      ...
      {!expanded && (
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-[rgba(251,146,60,0.90)] font-medium">
        ...
        <div className="p-4 md:p-5 space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 space-y-2">
              <p className="text-xl font-semibold text-[#CE2029]">
              ...
              <button
                ...
                className="group/cta relative mt-1 inline-flex min-h-[44px] items-center gap-2 overflow-hidden rounded-xl px-4 py-2 text-sm font-semibold text-white transition-all hover:shadow-[0_0_16px_rgba(183,94,24,0.35)] active:scale-[0.97]"
