...
export { accuracyPillClassesForState, accuracyGradientForKey, buildAccuracyAriaLabel, accuracyPillDisplayLabel };
...
export function AccuracyPill({ pill }: AccuracyPillProps) {
  ...
  const displayLabel = accuracyPillDisplayLabel(pill);
