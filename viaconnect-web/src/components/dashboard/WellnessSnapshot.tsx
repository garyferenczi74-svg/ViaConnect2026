    ...
    <section className="rounded-2xl border border-white/10 bg-[#1E3054]/60 backdrop-blur-md p-4 sm:p-5">
      ...
      {loading || generating ? (
        ...
        <>
          ...
          <Link
            href="/wellness-analytics"
            className="group relative mt-3 flex items-center justify-center gap-1.5 overflow-hidden rounded-lg px-3 py-2 text-[11px] font-semibold text-white transition-all hover:shadow-[0_0_16px_rgba(45,165,160,0.35)] active:scale-[0.97]"
          ...
          >
            ...
            <span className="relative">View Full Analytics</span>
            <ArrowRight className="relative h-3 w-3" strokeWidth={2} />
          </Link>
        </>
      )}
    </section>
