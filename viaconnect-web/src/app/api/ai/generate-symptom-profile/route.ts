...
export async function POST() {
  try {
    ...
    const result = {
      ...
      actionPlan,
      farmceuticaProtocolSuggestion: { summary: "Based on your master patterns, a targeted FarmCeutica protocol addresses your top symptoms with enhanced-bioavailability delivery.", products: masterPatterns.flatMap(p => p.supplementProtocol) },
