...
const MOCK_RESPONSES: Record<string, string> = {
  ...
  grok: "Recent literature (Zhang et al., 2026, J Nutrigenomics) confirms that heterozygous MTHFR C677T carriers show 35% reduced enzyme activity. Current research supports methylfolate over folic acid, with Maximum Bioavailability in the ViaConnect formulation. The APOE E3/E4 finding warrants cardiovascular monitoring per latest AHA guidelines published this month.",
  gpt4o:
