...
const MOCK_RECOMMENDATIONS: Recommendation[] = [
  { gene: "MTHFR", variant: "C677T (heterozygous)", product: "MTHFR+", productId: "prod1", rationale: "Supports impaired methylation with bioavailable folate and B12. Maximum Bioavailability." },
