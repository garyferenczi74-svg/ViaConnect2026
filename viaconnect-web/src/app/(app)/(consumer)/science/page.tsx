    ...
    <div className="p-5 md:p-8 space-y-8 max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-white/30 mt-0.5">
              {ALL_EXPERTS.length} experts across {DOMAINS.length} disciplines power your Hannah analysis
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl bg-teal-400/[0.03] border border-teal-400/10 p-4">
        <p className="text-xs text-white/40 leading-relaxed">
          Every recommendation in your ViaConnect wellness profile is informed by the research and clinical frameworks of these recognized authorities. Hannah synthesizes their work across 14 specialty lenses to create your personalized blueprint.
        </p>
      </div>
