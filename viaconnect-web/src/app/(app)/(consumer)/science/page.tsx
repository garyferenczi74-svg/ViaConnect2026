    ...
    <div className="p-5 md:p-8 space-y-8 max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-white/30 mt-0.5">
              Source registry transparency plus expert frameworks that inform Hannah education
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl bg-teal-400/[0.03] border border-teal-400/10 p-4">
        <p className="text-xs text-white/40 leading-relaxed">
          Educational materials on ViaConnect are informed by published research and clinical
          frameworks from recognized authorities. Hannah synthesizes that corpus for briefing
          purposes. Review findings with a licensed clinician.
        </p>
      </div>
      ...
      <h2 className="text-base font-semibold text-white pt-2">Expert frameworks</h2>
      ...
      <div className="rounded-xl bg-white/[0.02] border border-white/8 p-5">
        <p className="text-xs text-white/25 leading-relaxed">
          This list represents the primary expert authorities whose research and clinical frameworks inform ViaConnect&apos;s Hannah AI engine. Their inclusion does not imply endorsement of ViaConnect or ViaConnect products. Educational briefings are generated by AI synthesis of published research and should be reviewed with your healthcare practitioner.
        </p>
      </div>
    </div>
  );
