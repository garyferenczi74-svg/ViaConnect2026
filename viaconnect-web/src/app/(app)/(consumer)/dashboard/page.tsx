...
export default function ConsumerDashboard() {
  ...
  return (
    ...
    <div
      className="min-h-screen w-full bg-center bg-bottom bg-no-repeat bg-scroll text-white md:bg-fixed"
      style={{ backgroundImage: `url('${DASHBOARD_HERO_IMAGE}')`, backgroundSize: '100% auto' }}
