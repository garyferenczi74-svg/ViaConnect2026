...
const TEMPLATES: Record<string, Array<{ title: (s: string) => string; summary: (s: string, focus: string) => string; tags: string[] }>> = {
  ...
  platforms: [
    ...
    { title: (s) => `${s} — Supplement bioavailability deep dive`, summary: (s) => `${s} compares liposomal, micellar, and standard supplement forms for absorption with Maximum Bioavailability.`, tags: ['bioavailability', 'liposomal'] },
