...
function ThinkingDots() {
  return (
    <div className="flex items-start max-w-[90%] md:max-w-[85%]">
...
export default function ConsumerAICopilotPage() {
  ...
  return (
    <div className="flex flex-col h-screen" style={{ background: '#0B1120' }}>
      {/* ── Fixed Header ── */}
      <header
        className="flex items-center gap-3 px-3 md:px-4 py-3 backdrop-blur-xl z-20"
        style={{
      ...
      <div
        ...
        className="flex-1 overflow-y-auto px-3 md:px-4 lg:px-6 py-4 md:py-5 space-y-4"
      >
        {messages.map((msg) => {
          if (msg.role === 'user') {
            return (
              <div key={msg.id} className="flex flex-col items-end">
                <div
                  className="max-w-[90%] md:max-w-[85%] lg:max-w-[75%] rounded-2xl px-3 md:px-4 py-2.5 md:py-3"
          ...
          // AI message
          return (
            <div key={msg.id} className="flex flex-col items-start max-w-[90%] md:max-w-[85%] lg:max-w-[75%]">
      ...
      <div
        className="glass-v2 px-3 md:px-4 pt-3 pb-2 z-20"
        style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}
      >
        {/* Input row */}
        <div className="flex items-center gap-2">
          <button className="w-10 h-10 min-h-[44px] min-w-[44px] flex-shrink-0 flex items-center justify-center rounded-full text-gray-400 hover:text-gray-200 transition-colors">
          ...
          <button
            ...
            className="flex-shrink-0 flex items-center justify-center rounded-full transition-all disabled:opacity-40 min-h-[44px] min-w-[44px]"
            style={{
              width: 40,
              height: 40,
