...
// Dashboard surface: Body Score gauge plus quick metrics plus contributors.
// Prompt 180 (2026-06-08) relocated this from /body-tracker to
// /body-tracker/dashboard so the root can host the My Biology hub.
