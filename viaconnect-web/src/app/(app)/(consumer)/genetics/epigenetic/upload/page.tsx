...
// Prompt 204 (2026-06-21): EpigenHQ epigenetic report verify-before-save flow.
// A member uploads a PDF or a photo of their epigenetic report, our vision
// extraction reads the measured markers, and the member verifies every reading
// (and the measurement date) before anything is written via
// /api/genetics/epigenetic/confirm. Mirrors the lab report flow in the same
// glass-v2 style. EpigenHQ readouts are framed as directions, not verdicts, so a
// chip is only ever neutral teal, never an alarm color.

import { useCallback, useRef, useState } from 'react';
import Link from 'next/link';
import {
  ArrowLeft, FileText, Hourglass, Loader2, ShieldCheck, AlertTriangle, CheckCircle2,
} from 'lucide-react';
...
export default function EpigenUploadPage() {
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/60 leading-relaxed mt-1">
                We read these from {preview.sourceFilename} with vision extraction. Check each
                reading, set the measurement date, then save. Nothing is written to your record
                until you confirm.
              </p>
            </div>
          </div>
