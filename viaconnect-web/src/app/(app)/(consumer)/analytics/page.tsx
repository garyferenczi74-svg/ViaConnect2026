...
export default function AnalyticsPage() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('https://nnhkcufyqjojdbvdrpky.supabase.co/storage/v1/object/public/Hero%20Images/Athlete%206.png')", backgroundSize: 'contain', backgroundPosition: 'top center', backgroundColor: '#1A2744' }}
    >
