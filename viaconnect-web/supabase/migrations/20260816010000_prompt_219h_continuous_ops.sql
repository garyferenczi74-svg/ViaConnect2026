...
INSERT INTO public.agent_cadence_jobs (
  ...
  ('thanos.allowlist', 'thanos', 'Thanos peptide allowlist crawl', 720, 45, 'B', 'cron_tick', 40,
   '{}'::jsonb),
  ('security.daily', 'security_advisor', 'Security Advisor daily', 1440, 60, 'none', 'hybrid', 30,
   '{}'::jsonb),
  ('performance.daily', 'performance_advisor', 'Performance Advisor daily', 1440, 60, 'none', 'hybrid', 30,
   '{}'::jsonb),
