// =============================================================================
// nutrition-insights-daily Edge Function (Prompt 192 Task 3)
// =============================================================================
// Thin cron relay. pg_cron (nutrition_insights_daily_cron) invokes this
...
// POSTs { trigger: 'daily' } to our own API.
// =============================================================================
...
function logEvent(
  ...
  console.log(
    JSON.stringify({ scope: 'insights.cron-relay.daily', level, message, ...fields }),
  );
}
