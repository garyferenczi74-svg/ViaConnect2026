---
slug: nutrition-genetics-carbohydrates
...
triggering_caq_flags:
  - t1d_or_t2d_on_insulin_or_sulfonylurea
  - hypoglycemia_history
  - pregnancy_or_gdm
  - eating_disorder_history
medical_caution_level: medium
safety_mode_filter: medium_no_carb_cutting
...
## Beans, fruit, and intact grains are not the same as sugar-sweetened drinks.
...
CDC and Dietary Guidelines language emphasizes vegetables, fruit, whole grains, beans, and fewer sugar-sweetened drinks. Genes do not replace that pattern. AMY1 copy number is not on this confirmed list and is not discussed as a finding here.
...
Some reports discuss caffeine timing near meals and post-meal glucose. That is a timing discussion, not a ban. A clinician or dietitian can help you test timing if it matters to you.
...
Do not double-diagnose. The insulin resistance card has its own confirmed list. This card does not declare insulin resistance from carbohydrate SNPs.
...
Follow carb quality already in the meal plan. If caffeine near meals is a question, a clinician or dietitian can help you test timing. If you use insulin or a secretagogue, do not cut carbohydrate from this page.
...
- Centers for Disease Control and Prevention. National Diabetes Prevention Program lifestyle change program (population food language; genes are not part of that program). https://www.cdc.gov/diabetes-prevention/lifestyle-change-program/index.html
