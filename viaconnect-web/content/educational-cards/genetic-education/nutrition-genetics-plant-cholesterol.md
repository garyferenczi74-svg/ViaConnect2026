---
slug: nutrition-genetics-plant-cholesterol
...
triggering_caq_flags:
  - unexplained_xanthomas
  - very_high_sitosterol_if_measured
  - pediatric_lipid_clinic
  - pregnancy
medical_caution_level: medium
safety_mode_filter: common_snp_education_only
...
## Plant sterols are not the same as cholesterol. This panel does not diagnose sitosterolemia.
...
rs11887534 is the well-known ABCG8 D19H coding change in gallstone and sterol literature. It is still not a sitosterolemia diagnosis from a consumer panel.

## Plant sterols vs cholesterol

Plant sterols are fats from plants. Most people absorb only a small fraction. Cholesterol is a different molecule. A standard lipid panel is not a sitosterol test.

## ABCG5 / ABCG8 common SNPs vs rare disease
...
Review lipid labs with a clinician. If xanthomas or a rare sterol disorder is in play, that is a specialist path, not this card. Do not start sterol supplements from this page.
...
- MedlinePlus Genetics. Sitosterolemia. https://medlineplus.gov/genetics/condition/sitosterolemia/
- Myrie SB, Steiner RD, Mymin D. Sitosterolemia. GeneReviews. https://www.ncbi.nlm.nih.gov/books/NBK131810/
- Buch S, et al. A genome-wide association scan identifies the hepatic cholesterol transporter ABCG8 as a susceptibility factor for human gallstone disease (rs11887534 D19H as a common coding change). 2007. https://europepmc.org/article/MED/17632509
- ClinicalTrials.gov. Effect of Plant Sterols on the Lipid Profile of Patients With Dyslipidaemia (APOE-related plant sterol response is not a consumer personalization rule). NCT02765516. https://clinicaltrials.gov/study/NCT02765516
