...
triggering_caq_flags:
  - known_ascvd
  - familial_hypercholesterolemia_workup
  - statin_or_pcsk9_therapy
  - pregnancy
  - medically_indicated_very_low_fat
medical_caution_level: medium
safety_mode_filter: medium_lipids_only
...
## Dietary fats are not one thing. Genes do not pick keto or low-fat for you.
...
APOE rs405509 is a promoter SNP. It is not the epsilon-2, epsilon-3, or epsilon-4 pair. Those coding variants (rs429358 and rs7412) live on the saturated-fat card. Do not treat rs405509 as an APOE e4/e4 result.

## Fat quality: oils, nuts, seeds, avocado, fish vs many ultra-processed fats

Dietary fats are not one thing. Oils, nuts, seeds, avocado, and fish differ from fats in many ultra-processed foods. Dietary Guidelines discuss fat as part of an overall pattern, including replacing some saturated fat with unsaturated fat for the population. This theme does not tell you to start or stop a named diet pattern.

## What this panel's gene list is used for in research
...
This theme does not tell you to start or stop keto, low-fat, or Mediterranean eating on its own. Do not start a supplement or stop a statin from this page. Cognitive-disease language is off limits here.
...
Review existing lipid labs with a clinician. Use meal-plan fat quality guidance if it already exists. Do not start a supplement or stop a statin from this page.
