...
const products: Product[] = [
  ...
  },
  {
    id: 36,
    name: 'NOS Support +',
    subtitle: 'Precision Support for Optimal Cardiovascular and Genetic Wellness',
    capsules: '60 Capsules',
    dosage: '1150 mg',
    price: '$86.99/mo',
    originalPrice: '$108.74',
    rationale: 'Matched to your NOS SNP status',
    rating: 4.8,
    reviews: 132,
    geneticMatch: true,
    subscription: true,
    image: '/products/nos-support.png',
    variant: 'gold',
  },
  {
    id: 37,
    ...
    dosage: '325 mg',
    price: '$44.99/mo',
    rationale: 'Plant-based omega-3 for brain & heart health',
    rating: 4.9,
    reviews: 312,
    geneticMatch: false,
    subscription: false,
    image: '/products/omega3-algal.png',
    variant: 'green',
  },
  {
    id: 38,
    ...
    dosage: '1550 mg',
    price: '$59.99/mo',
    rationale: 'Beauty from within — skin, hair & nail support',
    rating: 4.7,
    reviews: 198,
    geneticMatch: false,
    subscription: false,
    image: '/products/radiance.png',
    variant: 'pink',
  },
  {
    id: 39,
    ...
    dosage: '500 mg',
    price: '$39.99/mo',
    rationale: 'Adaptogenic immune & longevity support',
    rating: 4.9,
    reviews: 287,
    geneticMatch: false,
    subscription: false,
    image: '/products/reishi.png',
    variant: 'pouch',
    brand: 'ViaCura',
  },
  {
    id: 40,
    name: 'Relax +',
    subtitle: 'Advanced Neuro-Adaptive Relief for the Modern World',
    capsules: '60 Capsules',
    dosage: '525 mg',
    price: '$59.99/mo',
    rationale: 'Stress Relief | Sleep Quality | Mental Clarity',
    rating: 4.8,
    reviews: 234,
    geneticMatch: false,
    subscription: false,
    image: '/products/relax.png',
    variant: 'navy',
  },
  {
    id: 41,
    name: 'Replenish NAD +',
    subtitle: 'Advanced Cellular Energy',
    capsules: '60 Capsules',
    dosage: '740 mg',
    price: '$74.99/mo',
    rationale: 'Cellular Energy | Antioxidant Defense | Longevity Optimization',
    rating: 4.9,
    reviews: 298,
    geneticMatch: false,
    subscription: false,
    image: '/products/replenish-nad.png',
    variant: 'navy',
  },
  {
    id: 42,
    name: 'RevitalizHER+',
    subtitle: 'Postnatal Methylated Liposomal Capsules',
    capsules: '60 Capsules',
    dosage: '215 mg',
    price: '$59.99/mo',
    rationale: 'Postnatal recovery & methylation support',
    rating: 4.7,
    reviews: 108,
    geneticMatch: false,
    subscription: false,
    image: '/products/revitalizher.png',
    variant: 'pink',
  },
  {
    id: 43,
    ...
    price: '$79.99/mo',
    originalPrice: '$99.99',
    rationale: 'Matched to your RFC1 SNP status',
    rating: 4.8,
    reviews: 94,
    geneticMatch: true,
    subscription: true,
    image: '/products/rfc1-support.png',
    variant: 'gold',
  },
  {
    id: 44,
    name: 'Rise+',
    subtitle: 'Vitality Enhancement & Hormonal Optimization for Men',
    capsules: '60 Capsules',
    dosage: '1800 mg',
    price: '$69.99/mo',
    rationale: 'Testosterone Support | Stamina & Performance | Drive & Recovery',
    rating: 4.8,
    reviews: 276,
    geneticMatch: false,
    subscription: false,
    image: '/products/rise.png',
    variant: 'red',
  },
  {
    id: 45,
    name: 'SHMT Support +',
    subtitle: 'Precision Support for Optimal DNA Synthesis and Methylation',
    capsules: '60 Capsules',
    dosage: '1000 mg',
    price: '$84.99/mo',
    originalPrice: '$106.24',
    rationale: 'Matched to your SHMT SNP status',
    rating: 4.7,
    reviews: 87,
    geneticMatch: true,
    subscription: true,
    image: '/products/shmt-support.png',
    variant: 'gold',
  },
  {
    id: 46,
    name: 'Shred +',
    subtitle: 'Natural GLP-1 Activator Metabolic Rebalance and Recovery Methylated Liposomal Capsules',
    capsules: '60 Capsules',
    dosage: '1430 mg',
    price: '$79.99/mo',
    rationale: 'Metabolic rebalance & recovery support',
    rating: 4.9,
    reviews: 342,
    geneticMatch: false,
    subscription: false,
    image: '/products/shred.png',
    variant: 'red',
  },
  {
    id: 47,
    name: 'SOD Support +',
    subtitle: 'Precision Support for Optimal Antioxidant Defense and Cellular Health',
    capsules: '60 Capsules',
    dosage: '400 mg',
    price: '$79.99/mo',
    originalPrice: '$99.99',
    rationale: 'Matched to your SOD SNP status',
    rating: 4.7,
    reviews: 76,
    geneticMatch: true,
    subscription: true,
    image: '/products/sod-support.png',
    variant: 'gold',
  },
  {
    id: 48,
    name: 'Sproutables Children\'s Gummies',
    subtitle: 'Methylated Children\'s Multivitamins — Ages 4-12',
    capsules: '60 Gummies',
    dosage: '450 mg',
    price: '$39.99/mo',
    rationale: 'Advanced bioavailable multivitamins for peak growth and wellness',
    rating: 4.9,
    reviews: 412,
    geneticMatch: false,
    subscription: false,
    image: '/products/sproutables-gummies.png',
    variant: 'green',
  },
  {
    id: 49,
    name: 'Sproutables Infant Drops',
    subtitle: 'Methylated Liposomal Bioavailable Multivitamins — 0-12 Months',
    capsules: '50 ml',
    dosage: '3000 mg',
    price: '$34.99/mo',
    rationale: 'Advanced bioavailable multivitamins for peak growth and wellness',
    ...
    geneticMatch: false,
    subscription: false,
    image: '/products/sproutables-infant-drops.png',
    variant: 'green',
  },
  {
    id: 50,
    name: 'Sproutables Toddler Chewables',
    subtitle: 'Methylated Children\'s Multivitamins — Ages 1-3',
    capsules: '60 Chewables',
    dosage: '450 mg',
    price: '$37.99/mo',
    rationale: 'Advanced bioavailable multivitamins for peak growth and wellness',
    rating: 4.8,
    ...
    geneticMatch: false,
    subscription: false,
    image: '/products/sproutables-toddler-chewables.png',
    variant: 'green',
  },
  {
    id: 51,
    name: 'SUOX Support +',
    subtitle: 'Optimize Your Sulfur Metabolism. Enhance Your Vitality',
    capsules: '60 Capsules',
    dosage: '550 mg',
    price: '$79.99/mo',
    originalPrice: '$99.99',
    rationale: 'Matched to your SUOX SNP status',
    rating: 4.7,
    reviews: 68,
    geneticMatch: true,
    subscription: true,
    image: '/products/suox-support.png',
    variant: 'gold',
  },
  {
    id: 52,
    name: 'TCN2 Support +',
    subtitle: 'Optimize Your B12 Transport. Enhance Your Vitality',
    capsules: '60 Capsules',
    dosage: '225 mg',
    price: '$79.99/mo',
    originalPrice: '$99.99',
    rationale: 'Matched to your TCN2 SNP status',
    rating: 4.8,
    reviews: 91,
    geneticMatch: true,
    subscription: true,
    image: '/products/tcn2-support.png',
    variant: 'gold',
  },
  {
    id: 53,
    ...
    dosage: '525 mg',
    price: '$89.99/mo',
    rationale: 'Telomere support for cellular longevity',
    rating: 4.9,
    reviews: 214,
    geneticMatch: false,
    subscription: false,
    image: '/products/teloprime.png',
    variant: 'navy',
  },
  {
    id: 54,
    name: 'Thrive+',
    subtitle: 'Post Breastfeeding GLP-1 Activator Metabolic Rebalance and Recovery Methylated Liposomal Capsules',
    capsules: '60 Capsules',
    dosage: '2010 mg',
    price: '$74.99/mo',
    rationale: 'Post-breastfeeding metabolic recovery support',
    rating: 4.8,
    reviews: 156,
    geneticMatch: false,
    subscription: false,
    image: '/products/thrive.png',
    variant: 'pink',
  },
  {
    id: 55,
    name: 'ThyroBalance+',
    subtitle: 'Thyroid Function | Metabolic Efficiency | Adrenal Health',
    capsules: '60 Capsules',
    dosage: '1450 mg',
    price: '$69.99/mo',
    rationale: 'Thyroid Function | Metabolic Efficiency | Adrenal Health',
    rating: 4.8,
    reviews: 203,
    geneticMatch: false,
    subscription: false,
    image: '/products/thyrobalance.png',
    variant: 'pink',
  },
  {
    id: 56,
    name: 'ThyroCalm-G+',
    subtitle: 'Targeted Support for Graves Disease',
    capsules: '60 Capsules',
    dosage: '700 mg',
    price: '$74.99/mo',
    rationale: 'Autoimmune Thyroid Balance | Immune Modulation | Hyperthyroid Support',
    rating: 4.7,
    reviews: 118,
    geneticMatch: false,
    subscription: false,
    image: '/products/thyrocalm-g.png',
    variant: 'red',
  },
  {
    id: 57,
    ...
    dosage: '500 mg',
    price: '$44.99/mo',
    rationale: 'Immune support & gut health mushroom extract',
    rating: 4.9,
    reviews: 387,
    geneticMatch: false,
    subscription: false,
    image: '/products/turkey-tail.png',
    variant: 'white',
  },
  {
    id: 58,
    name: 'VDR Support +',
    subtitle: 'Optimize Your Vitamin D Pathway. Enhance Your Vitality',
    capsules: '60 Capsules',
    dosage: '425 mg',
    price: '$79.99/mo',
    originalPrice: '$99.99',
    rationale: 'Matched to your VDR SNP status',
    rating: 4.8,
    reviews: 104,
    geneticMatch: true,
    subscription: true,
    image: '/products/vdr-support.png',
    variant: 'gold',
  },
];
